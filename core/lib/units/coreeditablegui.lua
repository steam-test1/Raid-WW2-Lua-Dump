...
function CoreEditableGui:add_workspace(gui_object)
	...
	gui:child("std_text"):set_font(Idstring("core/fonts/diesel"))
...
function CoreEditableGui:set_font(font)
	...
	for _, gui in ipairs(self._guis) do
		gui.gui:child("std_text"):set_font(Idstring("core/fonts/diesel"))
	end
...
function CoreEditableGui:set_font_size(font_size)
	...
	for _, gui in ipairs(self._guis) do
		gui.gui:child("std_text"):set_font_size(self._font_size * (10 * gui.gui:child("std_text"):height() / 100) * 0.7)
	end
end
