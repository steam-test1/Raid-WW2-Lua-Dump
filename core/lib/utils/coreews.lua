...
function list_selector(params)
	...
	params.left_list_box = EWS:ListBox(params.panel, "list_selector_left", "LB_SORT,LB_EXTENDED")
	...
	params.right_list_box = EWS:ListBox(params.panel, "list_selector_right", "LB_SORT,LB_EXTENDED")
