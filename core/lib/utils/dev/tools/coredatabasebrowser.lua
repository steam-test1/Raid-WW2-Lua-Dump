...
function CoreDatabaseBrowser:create_main_frame()
	...
	self._search_box.list_box = EWS:ListBox(self._search_box.panel, "database_browser_search", "LB_SORT,LB_EXTENDED")
	...
	self._local_box.list_box = EWS:ListBox(self._local_box.panel, "database_browser_local", "LB_SORT,LB_EXTENDED")
