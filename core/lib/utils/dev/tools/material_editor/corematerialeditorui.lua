...
function CoreMaterialEditor:_create_main_frame()
	...
	self._material_list_box = EWS:ListBox(self._material_collapse_box:lower_panel(), "material_editor_list", "LB_SORT")
	...
	self._compile_info_text:set_font_family("FONTFAMILY_TELETYPE")
