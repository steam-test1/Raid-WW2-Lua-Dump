...
function CoreParticleEditorVisualizers:create_billboard()
	...
	p:add_value("camera_facing_sorted")
	p:add_value("camera_facing_not_depth_sorted")
	...
	p:add_value("effect_glow_view_angle_fallof")
	...
	p:add_value("effect_geometry_fade_out_glow")
