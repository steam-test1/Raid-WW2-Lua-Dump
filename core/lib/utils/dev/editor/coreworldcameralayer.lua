...
function WorldCameraLayer:build_panel(notebook)
	...
	self._camera_list = EWS:ListBox(self._ews_panel, "camera_layer_cameras", "LB_SINGLE,LB_HSCROLL,LB_NEEDED_SB,LB_SORT")
	...
	self._point_list = EWS:ListBox(self._ews_panel, "camera_layer_points", "LB_SINGLE,LB_HSCROLL,LB_NEEDED_SB,LB_SORT")
...
function WorldCameraLayer:build_sequence()
	...
	self._sequence_list = EWS:ListBox(self._ews_panel, "camera_layer_sequence_list", "LB_SINGLE,LB_HSCROLL,LB_NEEDED_SB,LB_SORT")
	...
	self._availible_sequence_camera_list = EWS:ListBox(self._ews_panel, "camera_layer_available_sequence_camera", "LB_SINGLE,LB_HSCROLL,LB_NEEDED_SB,LB_SORT")
	...
	self._sequence_camera_list = EWS:ListBox(self._ews_panel, "camera_layer_sequence_camera_list", "LB_SINGLE,LB_HSCROLL,LB_NEEDED_SB")
