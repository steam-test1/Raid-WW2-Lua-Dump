...
function PlayerCarry:_get_max_walk_speed(...)
	...
	multiplier = managers.buff_effect:is_effect_active(BuffEffectManager.EFFECT_BAGS_DONT_SLOW_PLAYERS_DOWN) and 1 or math.clamp(multiplier * managers.player:upgrade_value("player", "carry_penalty_decrease", 1), 0, 1)
