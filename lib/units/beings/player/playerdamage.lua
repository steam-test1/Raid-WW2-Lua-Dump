...
function PlayerDamage:damage_killzone(attack_data)
	...
	if attack_data.death_on_down and health_subtracted > self._health then
		self:_force_kill()
	end
...
function PlayerDamage:damage_fall(data)
	...
	local fatal_fall, deadly_fall = false, false
	...
	if not silent_fall and data.height > self._class_tweak_data.stealth.FALL_ALERT_MIN_HEIGHT then
