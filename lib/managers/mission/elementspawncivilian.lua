...
function ElementSpawnCivilian:init(...)
	...
	self._enemy_name = self._values.enemy and Idstring(self._values.enemy) or Idstring("units/vanilla/characters/enemies/models/german_grunt_light/german_grunt_light")
	self._units = {}
