...
function MenuManager:show_ok_only_dialog(title, text)
	...
	dialog_data.text = managers.localization:text(text)
...
function MenuManager:show_lost_connection_to_host_dialog()
	...
	dialog_data.title = managers.localization:text("dialog_returning_to_main_menu")
	dialog_data.text = managers.localization:text("dialog_lost_connection_to_server")
...
function MenuManager:show_deleting_current_operation_save_dialog()
	...
	dialog_data.title = managers.localization:text("dialog_deleting_current_job_title")
	dialog_data.text = managers.localization:text("dialog_deleting_current_job")
...
function MenuManager:show_peer_already_kicked_from_game_dialog(params)
	...
	dialog_data.title = managers.localization:text(title)
	dialog_data.text = managers.localization:text(Global.on_remove_peer_message or "dialog_mp_already_kicked_from_game_message")
...
function MenuManager:show_option_dialog(params)
	...
	dialog_data.text = params.message
...
function MenuManager:show_character_delete_dialog(params)
	...
	dialog_data.title = managers.localization:text("dialog_character_delete_title")
	dialog_data.text = params.text

	local yes_button = {}

	yes_button.text = utf8.to_upper(managers.localization:text("dialog_yes"))
	yes_button.callback_func = params.callback

	local no_button = {}

	no_button.text = utf8.to_upper(managers.localization:text("dialog_no"))
	no_button.class = RaidGUIControlButtonShortSecondary
	no_button.cancel_button = true
	dialog_data.button_list = {
		yes_button,
...
function MenuManager:show_respec_dialog(params)
	...
	dialog_data.title = managers.localization:text("menu_character_skills_retrain_dialog_title")
	dialog_data.text = managers.localization:text("menu_character_skills_retrain_dialog_text", {
		GOLD = params.gold,
	})
	...
	yes_button.text = utf8.to_upper(managers.localization:text("dialog_yes"))
	yes_button.class = RaidGUIControlButtonShortPrimaryGold
	yes_button.callback_func = params.callback_yes
...
function MenuManager:show_character_customization_purchase_dialog(params)
	...
	dialog_data.title = managers.localization:text("character_customization_purchase_confirm_title")
	dialog_data.text = managers.localization:text("character_customization_purchase_confirm_text", {
...
function MenuManager:show_gold_asset_store_purchase_dialog(params)
	...
	dialog_data.title = managers.localization:text("gold_asset_store_dialog_buy_title")
	dialog_data.text = managers.localization:text("gold_asset_store_dialog_buy_message", {
		AMOUNT = params.amount,
...
function MenuManager:show_skill_selection_invalid_dialog()
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_character_skills_selection_invalid_title"))
	dialog_data.text = utf8.to_upper(managers.localization:text("menu_character_skills_selection_invalid_text"))
	dialog_data.focus_button = 1

	local ok_button = {}

	ok_button.text = utf8.to_upper(managers.localization:text("dialog_ok"))
...
function MenuManager:show_skill_selection_confirm_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_character_skills_selection_confirmation_title"))
	dialog_data.text = utf8.to_upper(managers.localization:text("menu_character_skills_selection_confirmation_text"))
	dialog_data.focus_button = 1

	local yes_button = {}

	yes_button.text = utf8.to_upper(managers.localization:text("dialog_yes"))
	yes_button.callback_func = params.yes_callback
...
function MenuManager:show_kick_peer_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_kick_confirm_title"))
	dialog_data.text = utf8.to_upper(managers.localization:text("menu_kick_confirm_text", {
...
function MenuManager:show_save_slot_delete_confirm_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_mission_save_slot_delete_confirmation_title"))
	dialog_data.text = utf8.to_upper(managers.localization:text("menu_mission_save_slot_delete_confirmation_text"))
	dialog_data.focus_button = 1
...
function MenuManager:show_redeem_character_customization_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_loot_screen_redeem_character_customization_dialog_title", {
		XP = params.xp,
	}))
	dialog_data.text = utf8.to_upper(managers.localization:text("menu_loot_screen_dialog_text"))
	dialog_data.focus_button = 2
	...
	yes_button.text = managers.localization:text("dialog_yes")
	yes_button.callback_func = params.callback
	yes_button.class = RaidGUIControlButtonShortPrimary
...
function MenuManager:show_redeem_weapon_point_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_loot_screen_redeem_weapon_point_dialog_title", {
		XP = params.xp,
	}))
	dialog_data.text = utf8.to_upper(managers.localization:text("menu_loot_screen_dialog_text"))
	dialog_data.focus_button = 2
...
function MenuManager:show_character_create_dialog(params)
	...
	dialog_data.textbox = true
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_character_creation_create_title"))
	dialog_data.focus_button = 1
	dialog_data.textbox_value = params.textbox_value

	local yes_button = {}

	yes_button.text = utf8.to_upper(managers.localization:text("dialog_create"))
	yes_button.class = RaidGUIControlButtonShortPrimary
	yes_button.callback_func = params.callback_yes

	local no_button = {}

	no_button.text = utf8.to_upper(managers.localization:text("dialog_cancel"))
	no_button.class = RaidGUIControlButtonShortSecondary
	no_button.cancel_button = true
	no_button.callback_func = params.callback_no
	dialog_data.button_list = {
		yes_button,
		no_button,
	}
...
function MenuManager:show_mod_overrides_warning_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("menu_mod_overrides_warning_title"))
	dialog_data.text = managers.localization:text("menu_mod_overrides_warning_text")
	dialog_data.focus_button = 1

	local yes_button = {}

	yes_button.text = utf8.to_upper(managers.localization:text("dialog_go_to_mod_overrides"))
	yes_button.class = RaidGUIControlButtonShortPrimary
	yes_button.callback_func = params.callback_yes

	local no_button = {}

	no_button.text = utf8.to_upper(managers.localization:text("dialog_skip"))
	no_button.class = RaidGUIControlButtonShortSecondary
	no_button.cancel_button = true
	no_button.callback_func = params.callback_no
	dialog_data.button_list = {
...
function MenuManager:show_err_character_name_dialog(params)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("dialog_error_title"))
	dialog_data.text = managers.localization:text(params.textbox_id)
	dialog_data.no_upper = true

	local ok_button = {}

	ok_button.text = utf8.to_upper(managers.localization:text("dialog_ok"))
	ok_button.callback_func = params.callback_func
	dialog_data.button_list = {
		ok_button,
	}
...
function MenuManager:show_voice_chat_blocked_dialog(clbk)
	...
	dialog_data.title = utf8.to_upper(managers.localization:text("dialog_warning_title"))
	dialog_data.text = managers.localization:text("dialog_err_online_insufficient_privileges_voicechat")
	dialog_data.no_upper = true

	local ok_button = {}

	ok_button.text = utf8.to_upper(managers.localization:text("dialog_ok"))
	ok_button.callback_func = clbk and clbk or nil
	dialog_data.button_list = {
		ok_button,
	}
...
function MenuManager:show_err_new_patch()
	...
	dialog_data.title = string.upper(managers.localization:text("dialog_information_title"))
	dialog_data.text = managers.localization:text("dialog_err_game_patch_pkg_exists_02")
	dialog_data.no_upper = true
...
function MenuManager:show_no_active_characters()
	...
	dialog_data.title = managers.localization:text("dialog_error_title")
	dialog_data.text = managers.localization:text("dialog_no_active_characters")
...
function MenuManager:show_storage_removed_dialog(params)
	...
	dialog_data.title = managers.localization:text("dialog_warning_title")
	dialog_data.text = managers.localization:text("dialog_storage_removed_warning")
...
function MenuManager:show_unlock_mission_confirm_dialog(params)
	...
	dialog_data.title = managers.localization:text("mission_unlock_screen_confirm_unlock_title", {
		RAID = params.mission_title,
	})
	dialog_data.text = managers.localization:text("mission_unlock_screen_confirm_unlock_subtitle")
...
function MenuManager:show_play_together_rejected_message()
	...
	dialog_data.title = managers.localization:text("dialog_warning_title")
	dialog_data.text = managers.localization:text("dialog_play_together_reject_text")
...
function MenuManager:show_invite_rejected_message()
	...
	dialog_data.title = managers.localization:text("dialog_warning_title")
	dialog_data.text = managers.localization:text("dialog_invite_reject_text")
