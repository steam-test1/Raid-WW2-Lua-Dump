...
function UpgradeRally:check_activate()
...
function UpgradeRally:_on_damage_taken(attack_data)
...
function UpgradeRally:_on_damaged_enemy(params)
...
function UpgradeRally:_on_reset()
	self._rally_health = 0
