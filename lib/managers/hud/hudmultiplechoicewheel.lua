...
function HUDMultipleChoiceWheel:_exit_panel(id)
	...
	self._options[id].text:stop()
	self._options[id].text:clear_range_color(0, len)
	self._options[id].text:set_color(self.ICON_UNSELECTED_COLOR)
	self._options[id].icon:set_color(self.ICON_UNSELECTED_COLOR)
