...
function HUDWeaponClipShots:set_current_clip(current_clip)
	...
	local is_doublestack = (guis[1].texture_rect[4] / 2 <= self._ammo_panel:h() / 2 or guis[2].texture_rect[4] / 2 <= self._ammo_panel:h() / 2) and self._max_clip > self._icon_stack_min or false
