...
function RaidJobManager:save_game(data)
	...
	data.job_manager.bounty_completed_seed = self._bounty_completed_seed and tostring(self._bounty_completed_seed)
...
function RaidJobManager:sync_save(data)
	...
	state.is_job_bounty = (self._selected_job or self._current_job) and (self._selected_job or self._current_job).bounty
