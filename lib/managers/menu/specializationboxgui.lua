...
function SpecializationBoxGui:_create_text_box(ws, title, text, content_data, config)
	...
	exp_count_text:set_text(string.add_decimal_marks_to_string(tostring(xp_present)))
	...
	points_gained_count_text:set_text(string.add_decimal_marks_to_string(tostring(0)))
	...
	available_points_count_text:set_text(string.add_decimal_marks_to_string(tostring(available_points - points_present)))
...
function SpecializationBoxGui._update(o, self)
	...
	while self._anim_data and not self._anim_data.goto_end and (self._anim_data.xp_present ~= self._anim_data.end_xp_present or self._anim_data.points_present ~= self._anim_data.end_points_present) do
		...
		self._anim_data.exp_count_text:set_text(string.add_decimal_marks_to_string(tostring(math.round(self._anim_data.xp_present))))
		make_fine_text(self._anim_data.exp_count_text)
		self._anim_data.points_gained_count_text:set_text(string.add_decimal_marks_to_string(tostring(math.round(self._anim_data.points_present))))
		make_fine_text(self._anim_data.points_gained_count_text)
		self._anim_data.available_points_count_text:set_text(string.add_decimal_marks_to_string(tostring(math.round(self._anim_data.available_points_present))))
	...
	self._anim_data.exp_count_text:set_text(string.add_decimal_marks_to_string(tostring(math.round(self._anim_data.end_xp_present))))
	make_fine_text(self._anim_data.exp_count_text)
	self._anim_data.points_gained_count_text:set_text(string.add_decimal_marks_to_string(tostring(math.round(self._anim_data.end_points_present))))
	make_fine_text(self._anim_data.points_gained_count_text)
	self._anim_data.available_points_count_text:set_text(string.add_decimal_marks_to_string(tostring(math.round(self._anim_data.end_available_points_present))))
	make_fine_text(self._anim_data.available_points_count_text)
