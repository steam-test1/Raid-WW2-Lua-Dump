...
UpgradeStats.MACRO_MULTIPLIER = "PERCENTAGE"
UpgradeStats.MACRO_AMOUNT = "AMOUNT"
UpgradeStats.MACRO_TEMPORARY = "SECONDS"
UpgradeStats.MACRO_WARCRY = "DURATION"
UpgradeStats.COLOR_CHARACTER = "|"
