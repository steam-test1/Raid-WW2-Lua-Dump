...
function EventsTweakData:init()
	...
	self.active_duty_bonus_rewards[2].amount = 10
	...
	self.active_duty_bonus_rewards[3].amount = 20
	...
	self.active_duty_bonus_rewards[5].icon_outlaw = EventsTweakData.REWARD_ICON_OUTLAW
	self.active_duty_bonus_rewards[5].icon = EventsTweakData.REWARD_ICON_MANY
	self.active_duty_bonus_rewards[5].amount = 50
end
