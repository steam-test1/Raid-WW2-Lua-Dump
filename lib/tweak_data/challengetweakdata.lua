...
function ChallengeTweakData:init()
	...
	self.webley_kill_enemies_hipfire_hard = deep_clone(self.kill_enemies_hipfire_easy)
	self.webley_kill_enemies_hipfire_hard.target = 165
	self.webley_kill_enemies_hipfire_hard.reminders = {
		30,
		60,
		90,
		130,
